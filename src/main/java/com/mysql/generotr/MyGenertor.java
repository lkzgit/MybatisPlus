...
public class MyGenertor {
    ...
    public static void main(String[] args) {
        ...
        //mysql 数据库
        dsc.setUrl("jdbc:mysql://10.10.10.61:3306/mdt?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
        ...
        strategy.setInclude("jf_sys_patient");//可以指定多个表名
